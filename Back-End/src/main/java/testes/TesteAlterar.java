...
public class TesteAlterar {
    public static void main(String[] args) {
        ...
        Aluno aluno = new Aluno(
                "Nicolas Maduro",           // nome
                "maduro.preso",           // nomeUsuario
                "senha123",             // senha
                "aluno",                // tipo
                "maduro.cia@fbi.com",   // email
                "20240001",             // matricula (String)
                "3º Ano em condicional",            // serie
                "aprovado",             // status
                notas,                  // lista de notas
                observacoes             // lista de observacoes
        );
        Document alunoJson = new Document();
        alunoJson=aluno.paraJson();
        System.out.println(alunosDAO.atualizarAluno("6989e80e71c5716971bb4469",alunoJson));
    }
}
